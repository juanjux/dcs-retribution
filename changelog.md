...
* **[Mission Generator]** New *Use JTAC if the faction has one defined* option, so the JTAC aircraft can be switched off mid-campaign instead of only in the new-game wizard.
