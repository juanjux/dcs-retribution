...
* **[Map]** Combatant (non-carrier) ship groups can be repositioned on the campaign map: give the group a destination (up to 80 nm/turn) and it moves at end of turn, like a carrier drags its escorts. Player-driven for now (no AI naval movement yet).
